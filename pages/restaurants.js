  ...
  render() {
    ...
    if (restaurant) {
      return (
        <>
          <div>
            <span style={{ fontSize: "1.4rem", fontFamily: "'Gothic A1', Roboto, Helvetica, Arial, 'Open Sans'", fontWeight: "700", marginLeft: "30px", marginBottom: "50px", paddingBottom: "50px" }}>{restaurant.name}</span>
          </div>
