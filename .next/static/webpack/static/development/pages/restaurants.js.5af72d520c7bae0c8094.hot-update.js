...
function (_React$Component) {
  ...
  function AppProvider(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "clearItems", function (item) {
      var items = _this.state.items; //check for item already in cart
      //if not in cart, add item if item is found increase quanity ++
      ...
      if (newItem.quantity > 1) {
        ...
        var _items2 = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_this.state.items);

        var index = _items2.findIndex(function (i) {
          return i.id === newItem.id;
        });

        _items2.splice(index, 1);
...
//# sourceMappingURL=restaurants.js.5af72d520c7bae0c8094.hot-update.js.map